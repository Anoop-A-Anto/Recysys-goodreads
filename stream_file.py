...
image_string=f"""
    ...
    .reportview-container {{
        background: url(data:image/{main_bg_ext};base64,{base64.b64encode(open(main_bg, "rb").read()).decode()};background-size: cover)
    }}
   .sidebar.sidebar-content {{
    ...
    """
st.markdown(image_string,unsafe_allow_html=True)
